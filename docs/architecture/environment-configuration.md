...
| KEYCLOAK_ISSUER_URL  | Keycloak realm issuer URL                                   | http://localhost:8080/realms/ecosystem                                  | https://auth.adrianmorillo.com/realms/ecosystem                               |
| KEYCLOAK_JWKS_URI    | Keycloak JWKS endpoint used to retrieve public signing keys | http://localhost:8080/realms/ecosystem/protocol/openid-connect/certs    | https://auth.adrianmorillo.com/realms/ecosystem/protocol/openid-connect/certs |
